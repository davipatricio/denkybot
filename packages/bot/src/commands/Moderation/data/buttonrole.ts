    ...
    this.setName('buttonrole')
      ...
      .addSubcommand(
        new SlashCommandSubcommandBuilder()
          ...
          .addRoleOption(new SlashCommandRoleOption().setName('cargo2').setDescription('Cargo para adicionar ou remover quando o botão for clicado').setRequired(true))
          .addRoleOption(new SlashCommandRoleOption().setName('cargo3').setDescription('Cargo para adicionar ou remover quando o botão for clicado').setRequired(true))
          .addRoleOption(new SlashCommandRoleOption().setName('cargo4').setDescription('Cargo para adicionar ou remover quando o botão for clicado').setRequired(true))
          .addRoleOption(new SlashCommandRoleOption().setName('cargo5').setDescription('Cargo para adicionar ou remover quando o botão for clicado').setRequired(false))
      );
  }
}
