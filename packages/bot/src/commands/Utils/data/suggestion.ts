        ...
        new SlashCommandSubcommandBuilder()
          ...
          .addStringOption(
            new SlashCommandStringOption()
              .setMinLength(18)
              .setMaxLength(21)
              .setName(this.t('en_US', 'commandNames:suggestion/accept/id'))
              .setNameLocalization('pt-BR', this.t('pt_BR', 'commandNames:suggestion/accept/id'))
        ...
        new SlashCommandSubcommandBuilder()
          ...
          .addStringOption(
            new SlashCommandStringOption()
              .setMinLength(18)
              .setMaxLength(21)
              .setName(this.t('en_US', 'commandNames:suggestion/deny/id'))
              .setNameLocalization('pt-BR', this.t('pt_BR', 'commandNames:suggestion/deny/id'))
        ...
        new SlashCommandSubcommandBuilder()
          ...
          .addStringOption(
            new SlashCommandStringOption()
              .setMinLength(18)
              .setMaxLength(21)
              .setName(this.t('en_US', 'commandNames:suggestion/edit/id'))
              .setNameLocalization('pt-BR', this.t('pt_BR', 'commandNames:suggestions/edit/id'))
